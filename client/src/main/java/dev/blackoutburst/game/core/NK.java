...
public class NK {
    ...
    public NK() {
        try {
            this.ttf = IOUtils.ioResourceToByteBuffer("roboto.ttf", 512 * 1024);
        } catch (IOException e) {
    ...
    public void init(long window) {
        ...
        try (MemoryStack stack = stackPush()) {
            ...
            GL11.glBindTexture(GL_TEXTURE_2D, fontTexID);
            GL11.glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8, BITMAP_W, BITMAP_H, 0, GL_RGBA, GL_UNSIGNED_INT_8_8_8_8_REV, texture);
    ...
    public void newFrame(long window) {
        try (MemoryStack stack = stackPush()) {
